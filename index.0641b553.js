...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    menuItems.forEach((link)=>{
        ...
        if (getLastPathSegment(link.href) === currentPath) link.parentElement.classList.add("menu-item--active");
    });
});

},{"animate.css":"8t3va"}],"8t3va":[function() {},{}]},["gbXMy","bNKaB"], "bNKaB", "parcelRequire0143")
